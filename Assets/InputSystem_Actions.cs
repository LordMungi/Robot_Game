...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Robot_Attack = m_Robot.FindAction("Attack", throwIfNotFound: true);
        ...
        m_Robot_Previous = m_Robot.FindAction("Previous", throwIfNotFound: true);
        m_Robot_Next = m_Robot.FindAction("Next", throwIfNotFound: true);
        m_Robot_Sprint = m_Robot.FindAction("Sprint", throwIfNotFound: true);
        // UI
    ...
    ~@InputSystem_Actions()
    {
        UnityEngine.Debug.Assert(!m_Robot.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Robot.Disable() has not been called.");
    ...
    private readonly InputAction m_Robot_Attack;
    ...
    private readonly InputAction m_Robot_Previous;
    private readonly InputAction m_Robot_Next;
    private readonly InputAction m_Robot_Sprint;
    /// <summary>
    ...
    public struct RobotActions
    {
        ...
        /// </summary>
        public RobotActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Robot/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_Robot_Move;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_Robot_Look;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Attack".
        /// </summary>
        public InputAction @Attack => m_Wrapper.m_Robot_Attack;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_Robot_Interact;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Crouch".
        /// </summary>
        public InputAction @Crouch => m_Wrapper.m_Robot_Crouch;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Jump".
        /// </summary>
        public InputAction @Jump => m_Wrapper.m_Robot_Jump;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_Robot_Previous;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_Robot_Next;
        /// <summary>
        /// Provides access to the underlying input action "Robot/Sprint".
        /// </summary>
        public InputAction @Sprint => m_Wrapper.m_Robot_Sprint;
        /// <summary>
